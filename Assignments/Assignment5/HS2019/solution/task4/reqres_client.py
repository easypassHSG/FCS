        ...
        try:
            ...
            for user in users:
                ...
                try:
                    ...
                    user_list.append(User(first_name, last_name, email, user_id))
                except:
                
                    user_list.append(User(first_name, last_name, email))
        except:
            pass
...
def create_new_user(url, user):
    ...
    if request.status_code == 201:
        ...
        return (int(request.json()['id']), str(request.json()['createdAt']))
    else:
        return (None, None)
